...
export function TicketCard({
  ...
  return (
    <div
      className="rounded-lg shadow-md border border-zinc-300 dark:border-zinc-600 bg-amber-50 dark:bg-zinc-800 relative overflow-hidden select-none"
      style={{ width, height }}
    >
      <div
      ...
      {opposite ? (
        ...
        <>
          ...
          <svg
            width={width}
            height={height}
            className="absolute inset-0 text-zinc-700 dark:text-zinc-300"
          >
            <line
              x1={ax}
              y1={ay}
