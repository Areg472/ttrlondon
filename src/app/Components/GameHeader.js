  ...
  return (
    <header className="mb-8 text-center flex items-center justify-center gap-12">
      ...
      <div className="z-50 select-none">
        <div className="bg-white dark:bg-zinc-800 border-2 border-zinc-800 dark:border-zinc-200 rounded-2xl px-6 py-3 shadow-lg flex flex-col items-center">
          <span className="text-[10px] uppercase font-black tracking-[0.2em] text-zinc-400 mb-0.5">
            Points
          </span>
          <span className="text-3xl text-zinc-800 dark:text-zinc-100 tabular-nums leading-none">
            {score}
          </span>
        </div>
      </div>
