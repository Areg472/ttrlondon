...
export function GameHeader({
 ...
 <div className="bg-white border-2 border-zinc-800 rounded-2xl px-6 py-3 shadow-lg flex flex-col items-center">
 <span className="text-[10px] uppercase font-black tracking-[0.2em] text-zinc-400 mb-0.5">
 Points
 </span>
 <span className="text-3xl text-zinc-800 tabular-nums leading-none">
 {score}
 </span>
 </div>
 </div>
