...
export function City({ name, number, x, y, labelPosition = "top" }) {
 ...
 return (
 <div
 className="absolute flex items-center justify-center rounded-full border-2 border-zinc-800 bg-white shadow-md"
 style={{
 width: "32px",
 height: "32px",
 left: x,
 ...
 {name && (
 <div
 className={`absolute whitespace-nowrap text-xs font-semibold text-zinc-700 pointer-events-none ${getLabelStyle(labelPosition)}`}
 style={{
 textShadow:
