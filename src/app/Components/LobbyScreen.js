      ...
      <div className="bg-white dark:bg-zinc-800 p-12 rounded-[40px] shadow-2xl border border-zinc-200 dark:border-zinc-700 flex flex-col items-center max-w-md w-full text-center gap-6">
        ...
        <input
          ...
          onKeyDown={(e) => {
            ...
            else if (mode === "join" && roomCode.trim()) joinRoom();
          }}
        />
          ...
          <div className="flex flex-col gap-3 w-full">
            <div className="flex gap-4 w-full">
              <button
                ...
                className="flex-1 py-4 rounded-2xl bg-zinc-800 text-white font-black hover:scale-105 transition-transform shadow-lg cursor-pointer"
              >
                Create Room
              </button>
              <button
        ...
        {mode === "create" && (
          <div className="flex flex-col gap-3 w-full">
            ...
            <button
              onClick={createRoom}
              className="w-full py-4 rounded-2xl bg-zinc-800 text-white font-black hover:scale-105 transition-transform shadow-lg cursor-pointer"
            >
              Create Room
            </button>
          </div>
